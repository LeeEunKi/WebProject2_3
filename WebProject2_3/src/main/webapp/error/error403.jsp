...
<body>
	<nav class="shelf">
	  <a href="../main/main.do" class="book home-page">Home page</a>
	  <a href="../book/search.do" class="book about-us">책 빌리러 가기 </a>
	  <a href="../board/list.do" class="book contact">게시판</a>
	  <a href="../study/room_list.do" class="book faq">열람실 예약하기</a>
